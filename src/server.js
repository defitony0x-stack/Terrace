...
// Polls every 1 minute so low thresholds (e.g. 2 minutes) stay accurate
// — with a coarser poll, a low threshold could lag by nearly double its
// own value before actually firing.
setInterval(() => {
